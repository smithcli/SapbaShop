...
const login = async (email, password)=>{
    try {
        const res = await (0, _apiFetch.apiFetch)("/users/login", "POST", {
            email,
            password
        });
...
},{"./modules/apiFetch":"fPB6p","./modules/alerts":"6LXhu"}],"fPB6p":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "apiFetch", ()=>apiFetch);
